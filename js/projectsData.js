...
export const projects = [
  {
    ...
    name: "Cool Shader Effect",
    date: "2025-03-20",
    year: "2025",
    type: "Shader / WebGL",
    description:
      "A short description of this amazing shader project goes here.",
    thumbnail: "https://placehold.co/300x200/00aaff/white?text=Shader+FX",
  },
  {
    id: "unreal-20250210",
    slug: "interactive-unreal-scene",
    name: "Interactive Unreal Scene",
    date: "2025-02-10",
    year: "2025",
    type: "Unreal Engine",
    description:
      "Brief overview of the Unreal Engine project and its features.",
    thumbnail: "https://placehold.co/300x200/7700ff/white?text=Unreal+Scene",
  },
  {
    id: "vr-20260105",
    slug: "webvr-experiment",
    name: "WebVR Experiment",
    date: "2026-01-05",
    year: "2026",
    type: "WebXR",
    description:
